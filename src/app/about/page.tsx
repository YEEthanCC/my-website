...
export default function AboutPage() {
    return (
        <div className="w-full flex justify-center">
            <div className="w-2/3">
                <h1 className="text-xl mt-8">Education Background</h1>
                <ul className="ms-8">
                    <li className="mt-4">Bachelor of Applied Science, Computer Science from Simon Fraser University</li>
                </ul>
                <h1 className="text-xl mt-8">Professional Experience</h1>
                <ul className="ms-8">
                    <li className="mt-4">Software Engineer Intern at Advantech</li>
                    ...
                    <li className="mt-4">Lv. 108 on Arknights</li>
                </ul>
            </div>
        </div>
    )
